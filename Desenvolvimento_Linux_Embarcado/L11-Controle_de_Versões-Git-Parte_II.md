...
1. Criando um Primeiro BranchNo repositório atual, temos os seguintes arquivos:
dev1.txt
devtitans2.txt
cod1.txt
cod2.txt
...
3. Usando o GitHubO GitHub é um serviço que armazena nossos projetos Git e nos auxilia a gerenciá-los. Se você tiver seu projeto hospedado no GitHub, poderá acessar e baixar esse projeto com um comando em qualquer computador ao qual tenha acesso. Em seguida, você pode fazer suas alterações e enviar a versão mais recente de volta ao GitHub. É uma excelente vitrine para expor nossos trabalhos e estudos.
...
4. Clonando um RepositórioVamos supor que por engano, apagamos o repositório local, ou estamos em outro computador e precisamos desse repositório. Para exemplificar esta situação, apague a pasta devtitans-git que foi criada para esse laboratório.
cd ..
rm -rf devtitans-git
...
git pull
Already up to date.
5. Finalizando com o Push e PullPara finalizarmos o conceito de push e pull, faremos uma simulação para facilitar o entendimento.
